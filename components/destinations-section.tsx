...
const destinations: Destination[] = [
  ...
  },
  {
    ...
    department: "valle",
    departmentName: "Valle del Cauca",
    description: "Playa virgen dentro de la bahía de Buenaventura con aguas tranquilas y arena blanca.",
    travelTime: "30min desde Buenaventura",
    fromPort: "Buenaventura",
    highlights: ["Playa", "Bahía", "Tranquila"],
    image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=600&auto=format&fit=crop",
  },
  {
    id: "pianguita",
    ...
    department: "valle",
    departmentName: "Valle del Cauca",
    description: "Hermosa playa dentro de la bahía con aguas cristalinas y ecosistemas marinos únicos.",
    travelTime: "35min desde Buenaventura",
    fromPort: "Buenaventura",
    highlights: ["Playa", "Ecosistema", "Marino"],
